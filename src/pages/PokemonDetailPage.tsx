...
export function PokemonDetailPage() {
  ...
  const isFavourite = useFavouritesStore((s) => s.isFavourite(p.name));
...
/**
 * Router's errorElement for this route: rendered in place of
 * PokemonDetailPage whenever pokemonDetailLoader throws (e.g. a 404 or
 * network error from PokeAPI).
 */
